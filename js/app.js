...
class UI {
  imprimirAlerta(mensaje, tipo) {
    ...
    //Quitar el mensaje de error despues de 5 segundos
    setTimeout(() => {
      divMensaje.remove();
    }, 5000);
  }
...
// Objeto con la cita informacion de la cita
const citaObj = {
  mascota: "",
  propietario: "",
  telefono: "",
...
function nuevaCita(e) {
  ...
  //Reiniciar el objeto para la validadcion
  reiniciarObjeto();
